...
class CreateTableJob extends Migration
{
    ...
    public function up()
    {
        Schema::create('job', function (Blueprint $table) {
            ...
            $table->string('job_number', 255)->nullable(false);
            ...
            $table->string('fault_1', 3000)->nullable();
            $table->string('fault_2', 3000)->nullable();
            $table->string('fault_3', 3000)->nullable();
            $table->string('fault_4', 3000)->nullable();
            $table->integer('job_status')->default(1)->comment('Pending job define as a 1 and Done job define as a 2');
